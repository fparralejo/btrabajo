...
<table id="seguimiento" class="table table-striped table-bordered table-hover" cellspacing="0" width="100%">
    ...
    $url="javascript:leerSeguimiento(".$seguimiento->id_seguimiento.",".$id_oferta.");";
    ?>
        <tr>
            ...
            <td>
                <button type="button" onclick="borrarSeguimiento({{ $seguimiento->id_seguimiento }},{{ $id_oferta }})" class="btn btn-xs btn-danger">Borrar</button>
            </td>
        </tr>
    @endforeach
    </tbody>
...
<form role="form" class="form-horizontal" id="seguimientoForm" name="seguimientoForm" action="{{ URL::asset('seguimiento') }}" method="post">
    ...
    <input type="hidden" id="id_oferta" name="id_oferta" value="{{ $id_oferta }}" />
